...
//    UITapGestureRecognizer *tapView = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(cleanDisk)];
...
//    NSLog(@"成功清理－－%fMB",(([[SDImageCache sharedImageCache] getSize]/1024.0)/1024.0));
//}
...
-(NSArray *)arrayImageUrlStr{
    if (!_arrayImageUrlStr) {//_1107-602
        _arrayImageUrlStr = @[@"http://pic.sjjiasu.com/upload/20160818/14/57b554c963f46.jpg",
